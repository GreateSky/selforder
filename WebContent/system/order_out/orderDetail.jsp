                  			...
                  			<div class="row">
                  				...
                  				<div class="col-md-6" style="border-left: 1px dashed #C0C0C0">
                  					<form class="form-horizontal">
										...
										<div class="form-group has-warning" >
										  <label for="inputEmail3" class="col-sm-3 control-label">配送人：</label>
										  <div class="col-sm-4">
										...
										<div class="form-group has-warning">
										  ...
										  <label for="inputEmail3" class="col-sm-7 control-label" style="border-top: 1px dashed #C0C0C0" ></label>
										</div>
										<div class="form-group has-warning" >
										  <label for="inputEmail3" class="col-sm-3 control-label"><font color="red">*</font>&nbsp;客户名称：</label>
										  <div class="col-sm-4">
											<input type="text" class="form-control" id="username" placeholder="客户名称" value="" >
										  </div>
										</div>
										<div class="form-group has-warning" >
										  <label for="inputEmail3" class="col-sm-3 control-label"><font color="red">*</font>&nbsp;客户电话：</label>
										  <div class="col-sm-4">
											<input type="text" class="form-control" id="tel" placeholder="客户电话" value="" >
										  </div>
										</div>
										<div class="form-group has-warning" >
										  <label for="inputEmail3" class="col-sm-3 control-label"><font color="red">*</font>&nbsp;收货地址：</label>
										  <div class="col-sm-4">
