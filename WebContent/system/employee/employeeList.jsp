                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group has-warning">
	                	<div class="col-sm-6">
	                        ...
	                        <button role="btn-shop-add" type="button" class="btn btn-warning" onclick="javascript:window.location.href='saveEmployee.jsp'"><i class="fa fa-plus-circle"></i>&nbsp;新增</button>
                        </div>
                    </div><!--/搜索信息 start-->
                    <!--员工列表start-->
